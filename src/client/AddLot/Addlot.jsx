                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <option value="Vehicle">Vehicle</option> */}
                                ...
                                <option value="Home Application">
                                  Home Application
                                </option>
                                <option value="Electronic">Electronic</option>
                                <option value="Outdoor Home">
                                  Outdoor Home
                                </option>
                                ...
                                <option value="Apple Accessories">
                                  Apple Accessories
                                </option>
                                <option value="Earphones">Earphones</option>
                                <option value="Gaming Accessory">
                                  Gaming Accessory
                                </option>
                                ...
                                <option value="Women's Cosmetics">
                                  Women's Cosmetics
                                </option>
                                <option value="Men's Cosmetics">
                                  Men's Cosmetics
                                </option>
                                <option value="Children's items">
                                  Children's items
                                </option>
                                <option value="MOBILE">Mobile</option>
                                <option value="CAR TOOLS">Car Tools</option>
                                <option value="LAPTOP ACCESSORY">
                                  Laptop Accessory
                                </option>
                                <option value="Beats & sound">
                                  Beats & sound
                                </option>
                                <option value="Security camera accessories">
